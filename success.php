...
$cart=44105;
$Mod="Online Mode";
    $re = mysqli_query($con4,"INSERT INTO view(cartid,Name,Products,Mode,Amount,DateOf,Transaction) VALUES($cart,'$firstname','$PName1','$Mod',$amount,'$RA','$RR')");
...
$pdf->SetFont('Arial','',12);
$pdf->Cell(40,5,$firstname,0,1);
$pdf->Cell(40,5,$email,0,1);
$pdf->Cell(40,5,$phone,0,1);
