...
if(isset($_POST["ded"]))
{
    $res = mysqli_query($con,"UPDATE money SET amount=0 WHERE cartid = 44105");
        echo "<script>alert('Money Deducted Successfully');</script>";
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg'); background-size: cover;background-repeat: no-repeat">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" action="Show_Money.php" method="post">
